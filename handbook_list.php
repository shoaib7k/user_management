        ...
        <div class="modal-dialog modal-dialog-scrollable">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="POST" action="handbook_list.php?act=add&theme_id=<?php echo $theme_id; ?>">
      ...
      <div class="container">
        ...
        ?>
                ...
                <div class="card-toolbar no-border">
                  ...
                  <div class="modal fade" id="editUser<?php echo $val['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Edit Handbook</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
            ...
            <form method="POST" action="training_list.php?act=add">
                            ...
                            <div class="form-group">
                              <label for="formGroupExampleInput">ID</label>
                              <input type="text" name="training_theme_id" class="form-control" value="<?php echo $document_theme; ?>" id="theme_id" readonly>
                            </div>
                            <div class="form-group">
                              <label for="formGroupExampleInput">ID</label>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="training_theme_name_old" class="form-control" value="<?php echo $document_value_name; ?>" id="current_theme" readonly>
                            </div>
                            <div class="form-group">
                          ...
                          <div>
        <div>PDF-Dokument</div>
    </div>
    <div class="handbook_document_change_table">
        <div class="handbook_document_change_row">
            <div class="handbook_document_change_cell_1">
                <input type="text" name="handbooks_file_name" class="edit_input_field edit_input_field_read_only" readonly="true" id="handbooks_file_name">
                <input type="file" style="display: none;" id="file_explorer" name="file_name">
            </div>
            <div class="handbook_document_change_cell_2">
                <img src='images/image-add.svg' name='button-image-add' onmouseover="this.src='images/image-add-red.svg'" onmouseout="this.src='images/image-add.svg'"  class="button_image_add img_button" id="document_search"/>
                
            </div>
        </div>
    </div>
    <div class="handbook_document_change_progress_panel" id="handbook_document_change_progress_panel">
        <div class="handbook_document_change_progress_bar" id="handbook_document_change_progress_bar">
            0%
        </div>    
    </div>
                            <div class="modal-footer">
