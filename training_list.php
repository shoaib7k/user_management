...
if ($_GET['act'] == 'add') {
    ...
    if (isset($_POST["training_theme_id"])) { $_training_theme_id = $_POST["training_theme_id"]; }
    if (isset($_POST["training_theme_name_old"])) { $_training_theme_name_old = $_POST["training_theme_name_old"]; }
    if (isset($_POST["training_theme_name_new"])) { $_training_theme_name_new = $_POST["training_theme_name_new"]; }
    ...
    if (isset($_FILES['file_name'])) {
        ...
        if (in_array($_FILES['file_name']['type'], $_image_types)) {
            ...
            if ($_FILES['file_name']['type'] == 'image/jpeg') { $_image_suffix = '.jpg'; }
            if ($_FILES['file_name']['type'] == 'image/gif' ) { $_image_suffix = '.gif'; }
            if ($_FILES['file_name']['type'] == 'image/png' ) { $_image_suffix = '.png'; }
...
<a onClick="return confirm('Are you sure you want to delete user <?php echo $val['login_name'];?>')" href="#?act=delete&id=<?php echo $val['id']; ?>" class="card-toolbar-btn btn btn-sm radius-1 btn-outline-success btn-h-outline-success px-15 mx-0 btn-tp"type="button">
   ...
   <div class="form-group">
                      <label for="formGroupExampleInput">ID</label>
                      <input type="text" name="theme_id" class="form-control" value="<?php echo $theme_id; ?>" id="theme_id" readonly>
                    </div>
                    <div class="form-group">
                      <label for="formGroupExampleInput">Current Theme Name</label>
                      <input type="text" name="current_theme" class="form-control" value="<?php echo $theme_name; ?>" id="current_theme" readonly>
                    </div>
                    <div class="form-group">
                      <label for="formGroupExampleInput">New Theme Name</label>
                      <input type="text" name="new_theme" class="form-control" id="new_theme">
                    </div>
 ...
 <div class="modal-footer">
                  ...
                  <center>
                <a href="#training&theme&<?php echo $theme_id; ?>&handbook" class="training_theme_link">Manuals</a>
                <br>
